        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
          {services.map((service, index) => (
            ...
            >
              ...
              <h2 className="text-white text-4xl md:text-5xl font-bold text-center mb-10 mt-10 leading-tight tracking-tight drop-shadow-lg ">
                {service.title}
              </h2>
              {/* Imagen protagonista, grande y con sombra elegante */}
              <div className="w-full flex justify-center mb-6">
                <div className="relative w-full max-w-lg h-[340px] md:h-[400px] rounded-2xl overflow-hidden bg-black group-hover:scale-105 transition-transform duration-400 shadow-lg">
                  <Image
                    src={service.image}
                    ...
                    style={{
                      ...
                      filter: "brightness(0.98) contrast(1.10)",
