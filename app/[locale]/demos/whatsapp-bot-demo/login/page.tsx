...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push(`/${locale}/demos/whatsapp-bot-demo/dashboard`);
      } else {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-purple-900 via-purple-700 to-white dark:from-black dark:via-purple-800 dark:to-purple-900">
      <div className="w-full max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 items-center p-6 mt-28">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-white dark:bg-black shadow-lg rounded-2xl p-10">
            ...
            <div className="mt-6 text-center">
              ...
              <button
                onClick={() =>
                  router.push(`/${locale}/demos/whatsapp-bot-demo/register`)
                }
          ...
          <div className="bg-white dark:bg-black shadow-lg rounded-2xl p-6">
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
              ...
              <li>
                📲 Después de iniciar sesión, verás un QR para escanear como si
                abrieras WhatsApp Web.
              </li>
              <li>
                🤖 Escanea el QR y tu WhatsApp lo responderá un agente de IA.
              </li>
            </ul>
            <div className="text-gray-500 dark:text-gray-300 text-xs p-4">
              Para desvincular tu WhatsApp, simplemente cierra la sesión en tu
              celular.
            </div>
          </div>
        </div>
      ...
      <div className="w-full text-yellow-500 text-center py-3">
        ⚠️ Advertencia: El bot responderá automáticamente a todas las
        conversaciones de WhatsApp y grupos vinculados. Asegura que no te genere
        problemas.
      </div>
    </div>
  );
