...
export default function Dashboard() {
  ...
  return (
    <div className="mt-28 min-h-screen flex flex-col bg-gradient-to-br from-purple-800 via-purple-500 to-white dark:from-black dark:via-purple-900 dark:to-purple-800 text-black dark:text-white transition-colors duration-300">
      {/* Header */}
            ...
            <div className="w-full p-8">
              <div className="bg-black p-4 rounded-lg shadow-md text-center">
                ...
                <button
                  ...
                  onClick={() =>
                    window.open("https://botopia.tech/contactUs", "_blank")
                  }
                >
                  Contáctanos Ahora
                </button>
          ...
          <div className="flex flex-col gap-6 bg-gradient-to-br from-purple-900 to-purple-600 rounded-2xl p-6 shadow-lg">
            ...
            <ul className="space-y-6">
              <li className="flex items-center gap-4">
                <img
                  src="/demos/demo-chatbot-steps/step1.svg"
                  alt="Paso 1"
              ...
              <li className="flex items-center gap-4">
                <img
                  src="/demos/demo-chatbot-steps/step2.svg"
                  alt="Paso 2"
                  className="w-auto h-20 object-contain"
                />
                <p className="text-gray-300">
                  Pídele a un amigo que te escriba por WhatsApp para probar el
                  bot.
                </p>
              </li>
              <li className="flex items-center gap-4">
                <img
                  src="/demos/demo-chatbot-steps/step3.svg"
                  alt="Paso 3"
                  className="w-auto h-20 object-contain"
                />
                <p className="text-gray-300">
                  El bot responderá automáticamente a tus conversaciones y
                  grupos.
                </p>
              </li>
              <li className="flex items-center gap-4">
                <img
                  src="/demos/demo-chatbot-steps/step4.svg"
                  alt="Paso 4"
                  className="w-auto h-20 object-contain"
                />
                <p className="text-gray-300">
                  Contacta a Botopía Technology para que haga tu Chat-Bot
                  personalizado.
                </p>
              </li>
            </ul>
      ...
      <footer className="w-full bg-gradient-to-br from-purple-900 to-black py-4 text-center text-sm text-gray-400">
        ⚠️ Advertencia: Este bot responderá automáticamente a todas las
        conversaciones de WhatsApp, incluidos grupos. Configúralo con
        precaución.
