...
export default function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setTimeout(() => router.push(`/${locale}/demos/whatsapp-bot-demo/login`), 7000);
            } else {
    ...
    return (
        <div className="min-h-screen flex items-center bg-gradient-to-br from-purple-900 via-purple-700 to-white dark:from-black dark:via-purple-800 dark:to-purple-900">
            ...
            <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 items-center p-6 mt-28">
                ...
                <div className="bg-white dark:bg-black shadow-lg rounded-2xl p-10">
                    ...
                    <div className="mt-6 text-center">
                        ...
                        <button
                            onClick={() => router.push(`/${locale}/demos/whatsapp-bot-demo/login`)}
                ...
                {/* Columna derecha: Video */}
                    ...
                    <div className="flex justify-center">
                        <img
                            ...
                            className="w-96 max-w-lg rounded-2xl "
                        />
                    </div>
