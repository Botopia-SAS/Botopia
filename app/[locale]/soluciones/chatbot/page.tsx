    ...
    <div className="relative bg-gradient-to-br from-black to-purple-950 text-white overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center justify-between relative">
        <div className="md:w-1/2 text-left relative z-10">
          ...
          <p className="text-lg text-white/80 mt-6">
            Transforma la forma en que interactúas con tus clientes con
            **asistentes virtuales** que automatizan tareas, mejoran la
            conversión y optimizan el servicio al cliente.
          </p>
          <Link href="/contactUs">
      ...
      <section className="max-w-7xl mx-auto px-6 mt-20">
        <h2 className="text-5xl font-extrabold text-white text-center mb-16">
          ...
          <span className="text-purple-400">Chatbot IA?</span>
        </h2>
      ...
      <section className="max-w-7xl mx-auto px-6 text-center mt-24 flex flex-col items-center gap-12">
        <h2 className="text-5xl font-extrabold text-white mb-10">
          Explora los <span className="text-purple-400">Tipos de Chatbots</span>{" "}
          IA
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {chatbotTypes.map((type, index) => (
            <div
              key={index}
              className="bg-purple-800 text-white px-6 py-4 rounded-lg shadow-md transform hover:scale-105 transition"
            >
              {type}
            </div>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-6 text-center mt-24">
        <h2 className="text-5xl font-extrabold text-white mb-10">
          <span className="text-purple-400">Así desarrollamos</span> tu Chatbot
          IA
        </h2>
      ...
      <section className="max-w-7xl mx-auto px-6 text-center mt-24">
        <h2 className="text-5xl font-extrabold text-white mb-10">
          <span className="text-purple-400">Casos de Uso</span> en Diferentes
          Industrias
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {useCases.map((useCase, index) => (
            <div
              key={index}
              className="bg-purple-900 p-6 rounded-xl shadow-lg hover:scale-105 transition"
            >
...
const benefits = [
  {
    ...
    description:
      "Automatiza respuestas y reduce costos de atención al cliente.",
  },
  {
    icon: "📈",
    title: "Aumento de Conversión",
    description: "Mejora la conversión con chatbots de ventas estratégicos.",
  },
  {
    icon: "💬",
    title: "Experiencia Personalizada",
    description: "Brinda una atención única a cada usuario con IA avanzada.",
  },
];
...
const useCases = [
  {
    title: "E-commerce",
    description: "Automatiza ventas y atención en tiendas online.",
  },
  {
    title: "Salud y Medicina",
    description: "Asistentes virtuales para consultas y agendamiento médico.",
  },
  {
    title: "Finanzas",
    description: "Chatbots que ayudan con transacciones y asesoría financiera.",
  },
];
