    ...
    <div className="bg-gradient-to-br from-gray-900 to-purple-950 text-white">
      ...
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between py-20 px-6">
        <div className="md:w-1/2 text-center md:text-left">
          <h1 className="text-6xl font-extrabold mb-6 text-purple-400">
            <span className="text-white">Apps Web</span> <br /> Eficientes y
            Escalables
          </h1>
          <p className="text-lg text-white mb-6">
            Construimos aplicaciones web modernas, escalables y seguras. Desde
            el diseño hasta el despliegue en la nube, te acompañamos en cada
            paso.
          </p>
          <Link href="/contactUs">
      ...
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row flex-wrap gap-8 mt-10">
        <h2 className="text-5xl font-extrabold text-center text-white w-full -mt-16 mb-20">
          <span className="text-purple-400">Antes de desarrollar</span> tu App
          Web, considera:
        </h2>
        {considerations.map((item, index) => (
          <div
            key={index}
            className="bg-gray-900 p-6 rounded-xl shadow-lg flex items-center space-x-4 w-full md:w-[48%] lg:w-[30%] hover:scale-105 transition"
          >
      ...
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 mt-20">
        ...
        <div className="md:w-[60%] text-left">
          ...
          <p className="text-lg text-white mb-12">
            No se trata solo de desarrollar una app, sino de crear{" "}
            <span className="text-white font-bold">una experiencia </span>
            que revolucione la forma en que interactúas con tus clientes. Cada
            clic, cada pantalla y cada función deben tener un propósito claro.
          </p>
      ...
      <section className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 mt-20">
        <div className="md:w-[50%] text-left">
          ...
          <p className="text-lg text-white mb-10">
            Nuestro proceso de desarrollo es ágil y eficiente, asegurando que
            cada detalle de tu aplicación web esté optimizado para el
          ...
          <div className="relative w-full h-[380px]">
            {developmentSteps.map((step, index) => (
              <div
                key={index}
                className={`absolute p-4 w-60 text-center rounded-xl shadow-lg text-white animate-float transition
        ...
        <div className="md:w-[45%] flex justify-end">
          <Image
            src="/web.png"
            alt="Proceso Desarrollo App Web"
            width={500}
            height={500}
            className="rounded-xl animate-float"
          />
